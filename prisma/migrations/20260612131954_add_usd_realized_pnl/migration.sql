...
CREATE TABLE "new_DailyEntry" (
    ...
    "usdRealizedPnl" REAL NOT NULL DEFAULT 0,
    "createdAt" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" DATETIME NOT NULL
);
INSERT INTO "new_DailyEntry" ("createdAt", "date", "etfDepositedEUR", "etfValueEUR", "freeRON", "id", "totalDepositedRON", "updatedAt", "usdFreeFunds", "usdNetProfitLoss", "usdTotalValue") SELECT "createdAt", "date", "etfDepositedEUR", "etfValueEUR", "freeRON", "id", "totalDepositedRON", "updatedAt", "usdFreeFunds", "usdNetProfitLoss", "usdTotalValue" FROM "DailyEntry";
